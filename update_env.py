...
new_vars = {
    ...
    'DATABASE_URL': 'libsql://classic-painters-cms-vercel-icfg-r3lafaz8tyflv3oeslbihuyy.aws-us-east-1.turso.io'
}
...
print("Successfully updated .env file with Turso credentials.")
